...
const List = ({ stylist }) => {
  ...
  const handleSubmit = async (string) => {
    ...
    try {
      const res = await axios.post(`https://cosmotologywm.herokuapp.com/api/v1/List`, {
        userIds,
      });
      setDeleteUser(false);
  ...
  const getClients = async () => {
    try {
      const results = await axios.get(`https://cosmotologywm.herokuapp.com/api/v1/client`);
  ...
  const sortStylist = async (text) => {
    ...
    try {
      const res = await axios.post(`https://cosmotologywm.herokuapp.com/api/v1/List/sort`, {
        text,
      });
  ...
  const sortClient = async (text) => {
    ...
    try {
      const res = await axios.post(
        `https://cosmotologywm.herokuapp.com/api/v1/List/sort2`,
        {
          text,
        }
      );
